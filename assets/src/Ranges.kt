...
typealias IntRange = IntProgression
fun IntRange(from: Int, endInclusive: Int) = IntProgression(from, endInclusive, 1)

value class IntProgression(val from: Int, val endInclusive: Int, val step: Int) : Iterable<Int> {

    operator fun contains(value: Int): Boolean = value >= from && value <= endInclusive
    infix fun step(step: Int) = IntProgression(from, endInclusive, step)
