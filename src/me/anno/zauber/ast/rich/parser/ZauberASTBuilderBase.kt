...
abstract class ZauberASTBuilderBase(
    ...
    companion object {
        ...
        val operators = mapOf(
            ...
            // logical
            "||" to Operator("||", 3, Associativity.LEFT),
            ...
            // infix
            "shl" to Operator("shl", 11, Associativity.LEFT),
            "shr" to Operator("shr", 11, Associativity.LEFT),
            "ushr" to Operator("ushr", 11, Associativity.LEFT),
            "and" to Operator("and", 11, Associativity.LEFT),
            "or" to Operator("or", 11, Associativity.LEFT),
            "xor" to Operator("xor", 11, Associativity.LEFT),
            "to" to Operator("to", 11, Associativity.LEFT),
            "step" to Operator("step", 11, Associativity.LEFT),
            "until" to Operator("until", 11, Associativity.LEFT),
            "downTo" to Operator("downTo", 11, Associativity.LEFT),
            ".." to Operator("..", 11, Associativity.LEFT),

            // these look like infix, but are special
            "as" to Operator("as", 12, Associativity.LEFT),
            "as?" to Operator("as?", 12, Associativity.LEFT),
            ...
            "?." to Operator(".?", 30, Associativity.LEFT),
            "." to Operator(".", 30, Associativity.LEFT),
            "::" to Operator("::", 30, Associativity.LEFT),
        )
        ...
        val unaryOperators = mapOf(
            "++" to Operator("++", 50, Associativity.LEFT),
            "--" to Operator("--", 50, Associativity.LEFT),
            "~" to Operator("-", 15, Associativity.LEFT),
        )
    ...
    fun readRHS(op: Operator): Expression =
        readExpression(if (op.associativity == Associativity.LEFT) op.precedence + 1 else op.precedence)
