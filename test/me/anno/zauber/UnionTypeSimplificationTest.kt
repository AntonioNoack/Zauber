...
import me.anno.zauber.IsSubTypeOfTest.Companion.unionTypes
...
""".testInheritance()
        ...
        assertEquals(UnionType(listOf(classA, classB, classC)), unionTypes(classA, classB, classC))
    }
...
""".testInheritance()
        ...
        assertEquals(classA, unionTypes(classA, classB, classC))
    }
