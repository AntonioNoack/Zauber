...
class SelfTypeTest {
    ...
    companion object {
        private val LOGGER = LogManager.getLogger(_root_ide_package_.me.anno.zauber.types.typeresolution.SelfTypeTest::class)
    }
    ...
    fun testSelfType() {
        ...
        _root_ide_package_.me.anno.zauber.types.typeresolution.SelfTypeTest.Companion.LOGGER.info("Resolved Self to $type1 (should be B)")
        assertTrue(type1 is ClassType)
        assertEquals("B", (type1 as ClassType).clazz.name)
        _root_ide_package_.me.anno.zauber.types.typeresolution.SelfTypeTest.Companion.LOGGER.info("Fields[$type1]: ${type1.clazz.fields}")
    ...
    fun testSelfType2() {
        ...
        _root_ide_package_.me.anno.zauber.types.typeresolution.SelfTypeTest.Companion.LOGGER.info("Resolved Self to $type (should be B)")
